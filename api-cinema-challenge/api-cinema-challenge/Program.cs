...
// Toggle InMemory for quick Swagger testing
...
using (var scope = app.Services.CreateScope())
{
    ...
    //if (!useInMemory) await ctx.Database.MigrateAsync(); // create/update schema for Postgres
    await DbSeeder.SeedAsync(ctx);                       // minimal demo data
}
